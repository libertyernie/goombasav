...
#pragma region Windows Form Designer generated code
	private: System::Windows::Forms::FlowLayoutPanel^  flpHash;
	...
	private: void InitializeComponent(void)
		{
			...
			this->flpHash = (gcnew System::Windows::Forms::FlowLayoutPanel());
			...
			this->listBox1->Size = System::Drawing::Size(130, 157);
			...
			// 
			this->splitContainer1->Panel2->Controls->Add(this->flpHash);
			this->splitContainer1->Panel2->Controls->Add(this->flpButtons);
			this->splitContainer1->Panel2->Controls->Add(this->flowLayoutPanel1);
			this->splitContainer1->Size = System::Drawing::Size(380, 157);
			...
			// flpHash
			// 
			this->flpHash->AutoSize = true;
			this->flpHash->Controls->Add(this->lblHash);
			this->flpHash->Controls->Add(this->lblHashVal);
			this->flpHash->Dock = System::Windows::Forms::DockStyle::Bottom;
			this->flpHash->Location = System::Drawing::Point(0, 115);
			this->flpHash->Name = L"flpHash";
			this->flpHash->Size = System::Drawing::Size(247, 13);
			this->flpHash->TabIndex = 9;
			// 
			// lblHash
			// 
			this->lblHash->AutoSize = true;
			this->lblHash->Location = System::Drawing::Point(0, 0);
			this->lblHash->Margin = System::Windows::Forms::Padding(0);
			this->lblHash->Name = L"lblHash";
			this->lblHash->Size = System::Drawing::Size(131, 13);
			...
			this->lblHashVal->Location = System::Drawing::Point(134, 0);
			this->lblHashVal->Name = L"lblHashVal";
			this->lblHashVal->Size = System::Drawing::Size(0, 13);
			...
			this->flpButtons->Location = System::Drawing::Point(0, 128);
			...
			this->flowLayoutPanel1->Size = System::Drawing::Size(247, 157);
			...
			this->ClientSize = System::Drawing::Size(380, 181);
			...
			this->flpHash->ResumeLayout(false);
			this->flpHash->PerformLayout();
...
#pragma endregion
	...
	private:
		...
		Void listBox1_SelectedIndexChanged(Object^ sender, EventArgs^ e) {
			...
			lblHashVal->Text = goomba_compressed_data_checksum(sh, 3).ToString("X6");
		}
