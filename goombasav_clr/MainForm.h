...
#pragma region Windows Form Designer generated code
	...
	private: void InitializeComponent(void)
	{
				 ...
				 this->listBox1->Size = System::Drawing::Size(130, 195);
				 ...
				 // 
				 this->splitContainer1->Panel2->Controls->Add(this->pnlHash);
				 this->splitContainer1->Panel2->Controls->Add(this->flpButtons);
				 this->splitContainer1->Panel2->Controls->Add(this->flowLayoutPanel1);
				 this->splitContainer1->Size = System::Drawing::Size(507, 195);
				 ...
				 this->pnlHash->Dock = System::Windows::Forms::DockStyle::Bottom;
				 this->pnlHash->Location = System::Drawing::Point(0, 142);
				 this->pnlHash->Margin = System::Windows::Forms::Padding(0);
				 this->pnlHash->Name = L"pnlHash";
				 this->pnlHash->Size = System::Drawing::Size(373, 17);
				 this->pnlHash->TabIndex = 9;
				 // 
				 // hashBox
				 // 
				 this->hashBox->Dock = System::Windows::Forms::DockStyle::Fill;
				 this->hashBox->Location = System::Drawing::Point(174, 0);
				 ...
				 this->flpButtons->Location = System::Drawing::Point(0, 159);
				 ...
				 this->flowLayoutPanel1->Size = System::Drawing::Size(373, 195);
	...
	private:
		...
		Void listBox1_SelectedIndexChanged(Object^ sender, EventArgs^ e) {
			...
			if (sh->size > sizeof(stateheader)) {
				uint64_t ck = goomba_compressed_data_checksum(sh, 3);
				pnlHash->Visible = true;
				lblHashVal->Text = ck.ToString("X6");
				hashBox->BackColor = Color::FromArgb((int)ck | 0xFF000000);
			} else {
				pnlHash->Visible = false;
			}
		}
